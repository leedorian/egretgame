window.skins={};
	...
	function LoginSkin() {
		_super.call(this);
		this.skinParts = ["bgIMG","WechatLoginBtn"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this._Image1_i(),this.bgIMG_i(),this._Image2_i(),this.WechatLoginBtn_i()];
	}
	var _proto = LoginSkin.prototype;
	...
	function LoginSkin() {
		_super.call(this);
		this.skinParts = ["avater","mobileinput","nationinput","receiveinput","musicState","musicSlider","saveBtn","back"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this._Image1_i(),this.avater_i(),this._Label1_i(),this._Label2_i(),this._Label3_i(),this._Label4_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this.mobileinput_i(),this.nationinput_i(),this.receiveinput_i(),this.musicState_i(),this.musicSlider_i(),this._Image5_i(),this.saveBtn_i(),this.back_i()];
	}
	var _proto = LoginSkin.prototype;
	...
	__extends(aboutUISkin, _super);
	var aboutUISkin$Skin12 = 	(function (_super) {
		__extends(aboutUISkin$Skin12, _super);
		function aboutUISkin$Skin12() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = aboutUISkin$Skin12.prototype;
	...
	function LoginSkin() {
		_super.call(this);
		this.skinParts = ["avater","nickText","power1","power2","power3","power4","power5","addmoney","addpower","moneyText","powerText"];
		
		this.height = 266;
		this.width = 1080;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.avater_i(),this._Image3_i(),this.nickText_i(),this.power1_i(),this.power2_i(),this.power3_i(),this.power4_i(),this.power5_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this.addmoney_i(),this.addpower_i(),this.moneyText_i(),this.powerText_i()];
	}
	var _proto = LoginSkin.prototype;
